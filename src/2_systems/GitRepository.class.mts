...
export default class DefaultGitRepository implements GitRepository {
  ...
  getAndInstallSubmodule(repoPath: string, path: string): Promise<SubmoduleInterface> {
    throw new Error("Method not implemented.");
  }
  addSubmodule(repoToAdd: GitRepository): Promise<SubmoduleInterface> {
    throw new Error("Method not implemented.");
  }
  getSubmodules(): Promise<SubmoduleInterface[]> {
    throw new Error("Method not implemented.");
  }
  init({ baseDir, clone, init, }: GitRepositoryParameter): Promise<GitRepository> {
    throw new Error("Method not implemented.");
  }
  // async init({
  //   baseDir,
